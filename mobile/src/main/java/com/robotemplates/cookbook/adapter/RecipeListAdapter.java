...
public class RecipeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static RecipeListFragment ctx;
    ...
    public RecipeListAdapter(RecipeListFragment ctx, List<RecipeModel> recipeList, List<Object> footerList, RecipeViewHolder.OnItemClickListener listener, int gridSpanCount) {
        this.ctx = ctx;
    ...
    public static final class RecipeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public RecipeViewHolder(View itemView, OnItemClickListener listener,
            ...
            // find views
            mNameTextView = (TextView) itemView.findViewById(R.id.fragment_recipe_list_item_name);
            mImageView = (ImageView) itemView.findViewById(R.id.fragment_recipe_list_item_image);
        }
        ...
        public void bindData(RecipeModel recipe) {
            ...
            mImageLoader.displayImage(recipe.getImage(),
                    mImageView,
